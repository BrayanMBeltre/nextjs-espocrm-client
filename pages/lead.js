...
export default function Leads() {
  const { data, error } = useSWR("/api/espocrm/Lead", fetcher);
  ...
  //   try {
  //     const { data } = await axios.get("/api/espocrm/Lead", payload);
  //     console.log(data);
  //   } catch (error) {
  //     console.log(error);
  //   }
  ...
  return (
    <div className="">
      <div className="flex justify-between">
        <div>
          <h1 className="text-4xl font-bold text-indigo-900 mt-">Leads</h1>
        </div>
        <div>
